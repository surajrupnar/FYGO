					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav menu__list">
								<li class="active">
									<a class="nav-stylehead" href="http://localhost:8800/admin/home.web">Home
										<span class="sr-only">(current)</span>
									</a>
								</li>
								<li class="">
									<a class="nav-stylehead" href="http://localhost:8800/admin/aboutUs.web">About Us</a>
								</li>
								<li class="dropdown">
								...
								<li class="">
									<a class="nav-stylehead" href="http://localhost:8800/admin/registration.web">CSR Registration</a>
								</li>
								<li class="dropdown">
...
<div class="services-breadcrumb">
	<div class="agile_inner_breadcrumb">
		<div class="container">
			<ul class="w3_short">
				<li><a href="http://localhost:8800/admin/home.web">Home</a> <i>|</i></li>
				<li>About Us</li>
			</ul>
		</div>
	</div>
