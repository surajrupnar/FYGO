...
<div class="header-bot">
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<div class="col-md-4 logo_agile">
			<h1>
				<a href="index.html"> <span>G</span>rocery <span>S</span>hoppy <img
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse menu--shylock"
						...
						<ul class="nav navbar-nav menu__list">
							<li><a class="nav-stylehead" href="http://localhost:8800/admin/home.htm">Home<span
									class="sr-only">(current)</span>
							</a></li>
							<li class="active"><a class="nav-stylehead"
								href="http://localhost:8800/admin/aboutUs.htm">About Us</a></li>
							...
							<li class=""><a class="nav-stylehead" href="http://localhost:8800/admin/registration">CSR Registration</a>
							</li>
							<li class="dropdown"><a
...
<div class="services-breadcrumb">
	<div class="agile_inner_breadcrumb">
		<div class="container">
			<ul class="w3_short">
				<li><a href="http://localhost:8800/admin/home.htm">Home</a> <i>|</i></li>
				<li>About Us</li>
			</ul>
		</div>
	</div>
